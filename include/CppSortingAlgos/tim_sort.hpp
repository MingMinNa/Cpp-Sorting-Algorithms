...
class TimSort
{
    public:
        ...
        inline static const uint8_t MIN_MERGE  = 32u;
    ...
    private:
        ...
        static std::size_t get_run(T* arr, std::size_t n, std::size_t run_start, Compare cmp);
...
void TimSort::tim_merge(
    ...
    if (n1 <= n2) merge_lo(arr, start, mid, end, min_gallop, cmp);
    else          merge_hi(arr, start, mid, end, min_gallop, cmp);
}
