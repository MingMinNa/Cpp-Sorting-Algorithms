/**
 * @file stooge_test.cpp
 * @brief  Tests for stooge sort.
 * @author MingMinNa
 */

#include "../include/stooge_sort.hpp"
...
std::vector<size_t> sort_test::test_sizes 
    = { 1u, 2u, 3u, 5u, 8u, 10u, 23u, 57u, 100u, 200u };
...
using Sort = StoogeSort;
std::string sort_name = "Stooge Sort";
