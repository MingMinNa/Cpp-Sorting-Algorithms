/**
 * @file bench_slow.cpp
 * @brief  Benchmark driver for slow comparison-based sorts.
 * @author MingMinNa
 */
...
int main(int argc, char *argv[])
{
    ...
    auto results = run_benchmark_suite<
        ...
        BubbleSort,          GnomeSort,     CocktailSort,   SelectionSort,      InsertionSort,
        BinaryInsertionSort, ShellSort,     CombSort,       CycleSort,          OddEvenSort,
        PancakeSort
    >(sort_sizes, seed, repeat);
    to_csv(results, "benchmarks/results", "slow-comparison");
